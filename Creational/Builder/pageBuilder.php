...
class HTMLPageDirector extends AbstractPageDirector {
    ...
    public function buildPage() {
        $this->builder->setTitle('Testing the HTMLPage <br>');
        $this->builder->setHeading('Testing the HTMLPage <br>');
        $this->builder->setText('Testing, testing, testing! <br>');
        $this->builder->setText('Testing, testing, testing, or! <br>');
        $this->builder->setText('Testing, testing, testing, more! <br>');
